...
/**
 * - Mirrored expo-image-picker/src/ImagePicker.
 * - NativeModulesProxy methods return undefined for Android.
 * - Deprecated NativeModulesProxy method in place requireNativeModule is the recommended method to use.
 * - Ideally either make a post requesting this change to occur in the next version or
 *   fork repo and create this change ourselves( do need to maintain until changes occur in dep ).
 * - my solution was more the latter with creating a of ImagePicker with the correct change and using it
 *   over expo-image-picker when on Android.
 *  */
const ExponentImagePicker = requireNativeModule("ExponentImagePicker");
